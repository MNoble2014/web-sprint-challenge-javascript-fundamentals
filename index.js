...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// The nestedFunction can access the internal variable because it is located within myFunction. 
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(data){
    const newZooAnimals = data.map(function(item) {
  ...
  */
  ...
  function lowPopulationAnimals(array) {
    let newArray = array.filter(function(item, i) {
      return array[i].population < 5
    });
    return newArray;
  }
  ...
  */
  ...
  function USApop(array) {
    let newArray = array.reduce(function(acc, item) {
